...
public class Day13Part1 {
    ...
    public static void main(String[] args) {
        TransparentEtPliures transparent = recupererTransparentEtPliures("entree.txt");
        long resultat = determinerNombrePointsApres1Pliure(transparent);
        System.out.println("Réponse=" + resultat);
    }

    private static long determinerNombrePointsApres1Pliure(TransparentEtPliures transparent) {
        transparent.plierUneFoisEnDeuxPartiesEgales();
        return transparent.getNombrePoints();
    }
